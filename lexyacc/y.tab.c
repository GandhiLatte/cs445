...
#line 30 "calc.y" /* yacc.c:1646  */
    { 
        tree_print((yyvsp[-1].tval));
        fprintf(stderr, "Value = %d\n", tree_eval((yyvsp[-1].tval)));
     }
...
#line 36 "calc.y" /* yacc.c:1646  */
    { (yyval.tval) = mktree('+',(yyvsp[-2].tval),(yyvsp[0].tval));}
...
#line 39 "calc.y" /* yacc.c:1646  */
    { (yyval.tval) = mktree(NUM,NULL,NULL); (yyval.tval)->attribute = (yyvsp[0].ival);}
